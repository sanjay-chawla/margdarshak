...
public class MargdarshakDirectionResponseFactory {

    private final MargdarshakDirection mapboxDirections;

    MargdarshakDirectionResponseFactory(MargdarshakDirection mapboxDirections) {
