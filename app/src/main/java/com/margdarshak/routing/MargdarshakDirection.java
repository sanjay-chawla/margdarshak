 ...
 */
@AutoValue
public abstract class MargdarshakDirection extends
        MapboxService<DirectionsResponse, OSRMService> {

    protected MargdarshakDirection() {
        super(OSRMService.class);
    }
    ...
    public void enqueueCall(final Callback<DirectionsResponse> callback) {
        getCall().enqueue(new Callback<DirectionsResponse>() {
            ...
            public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                MargdarshakDirectionResponseFactory factory = new MargdarshakDirectionResponseFactory(com.margdarshak.routing.MargdarshakDirection.this);
    ...
    /**
     * Build a new {@link com.margdarshak.routing.MargdarshakDirection} object with the initial values set for
     * {@link #baseUrl()}, {@link #profile()}, {@link #user()}, and {@link #geometries()}.
     *
     * @return a {@link com.margdarshak.routing.MargdarshakDirection.Builder} object for creating this object
     * @since 3.0.0
     */
    public static com.margdarshak.routing.MargdarshakDirection.Builder builder() {
        return new AutoValue_MargdarshakDirection.Builder()
    ...
    /**
     * Returns the builder which created this instance of {@link com.margdarshak.routing.MargdarshakDirection} and allows for
     * modification and building a new directions request with new information.
     *
     * @return {@link com.margdarshak.routing.MargdarshakDirection.Builder} with the same variables set as this directions object
     * @since 3.0.0
     */
    public abstract com.margdarshak.routing.MargdarshakDirection.Builder toBuilder();
    ...
    public abstract static class Builder {
         ...
         * @since 1.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder user(@NonNull String user);
         ...
         * @since 1.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder profile(@NonNull @ProfileCriteria String profile);
         ...
         * @since 1.0.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder origin(@NonNull Point origin) {
            this.origin = origin;
            return this;
        }
         ...
         * @since 1.0.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder destination(@NonNull Point destination) {
         ...
         * @since 3.0.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder addWaypoint(@NonNull Point waypoint) {
         ...
         * @since 1.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder alternatives(@Nullable Boolean alternatives);
         ...
         * @since 2.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder geometries(@GeometriesCriteria String geometries);
         ...
         * @since 1.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder overview(@Nullable @OverviewCriteria String overview);
         ...
         * @since 1.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder steps(@Nullable Boolean steps);
         ...
         * @since 1.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder continueStraight(@Nullable Boolean continueStraight);
         ...
         * @since 2.2.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder language(@Nullable Locale language) {
            if (language != null) {
        ...
        abstract com.margdarshak.routing.MargdarshakDirection.Builder language(@Nullable String language);
         ...
         * @since 3.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder roundaboutExits(@Nullable Boolean roundaboutExits);
         ...
         * @since 2.1.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder annotations(@Nullable @AnnotationCriteria String... annotations) {
            this.annotations = annotations;
            return this;
        }

        abstract com.margdarshak.routing.MargdarshakDirection.Builder annotation(@Nullable String annotation);
         ...
         * @since 2.0.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder addBearing(@Nullable @FloatRange(from = 0, to = 360) Double angle,
        ...
        abstract com.margdarshak.routing.MargdarshakDirection.Builder bearing(@Nullable String bearings);
         ...
         * @since 1.0.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder radiuses(@FloatRange(from = 0) double... radiuses) {
            this.radiuses = radiuses;
            return this;
        }

        abstract com.margdarshak.routing.MargdarshakDirection.Builder radius(@Nullable String radiuses);
         ...
         * @since 3.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder exclude(@ExcludeCriteria String exclude);
         ...
         * @since 3.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder voiceInstructions(@Nullable Boolean voiceInstructions);
         ...
         * @since 3.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder bannerInstructions(@Nullable Boolean bannerInstructions);
         ...
         * @since 3.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder voiceUnits(@Nullable @VoiceUnitCriteria String voiceUnits);
         ...
         * @since 1.0.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder clientAppName(@NonNull String clientAppName);
         ...
         * @since 2.1.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder baseUrl(String baseUrl);
         ...
         * @return this builder for chaining options together
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder interceptor(Interceptor interceptor);
         ...
         * @return this builder for chaining options together
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder networkInterceptor(Interceptor interceptor);
         ...
         * @return this builder for chaining options together
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder eventListener(EventListener eventListener);

        abstract com.margdarshak.routing.MargdarshakDirection.Builder coordinates(@NonNull List<Point> coordinates);
         ...
         * @since 3.2.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder addApproaches(String... approaches) {
            this.approaches = approaches;
            return this;
        }

        abstract com.margdarshak.routing.MargdarshakDirection.Builder approaches(@Nullable String approaches);
         ...
         * @since 4.4.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder addWaypointIndices(@Nullable @IntRange(from = 0) Integer... waypointIndices) {
            this.waypointIndices = waypointIndices;
            return this;
        }

        abstract com.margdarshak.routing.MargdarshakDirection.Builder waypointIndices(@Nullable String waypointIndices);
         ...
         * @since 3.3.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder addWaypointNames(@Nullable String... waypointNames) {
            this.waypointNames = waypointNames;
            return this;
        }

        abstract com.margdarshak.routing.MargdarshakDirection.Builder waypointNames(@Nullable String waypointNames);
         ...
         * @since 4.3.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder addWaypointTargets(@Nullable Point... waypointTargets) {
            this.waypointTargets = waypointTargets;
            return this;
        }

        abstract com.margdarshak.routing.MargdarshakDirection.Builder waypointTargets(@Nullable String waypointTargets);
         ...
         * @since 4.4.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder enableRefresh(Boolean enableRefresh);
         ...
         * @since 4.6.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder post() {
            usePostMethod(true);
            return this;
        }
         ...
         * @since 4.6.0
         */
        public com.margdarshak.routing.MargdarshakDirection.Builder get() {
            usePostMethod(false);
            return this;
        }
         ...
         * @since 4.8.0
         */
        public abstract com.margdarshak.routing.MargdarshakDirection.Builder walkingOptions(@NonNull WalkingOptions walkingOptions);

        abstract WalkingOptions walkingOptions();

        abstract com.margdarshak.routing.MargdarshakDirection.Builder usePostMethod(@NonNull Boolean usePost);

        abstract Boolean usePostMethod();

        abstract com.margdarshak.routing.MargdarshakDirection autoBuild();

        /**
         * This uses the provided parameters set using the {@link com.margdarshak.routing.MargdarshakDirection.Builder} and first checks that all
         * values are valid, formats the values as strings for easier consumption by the API, and lastly
         * creates a new {@link com.margdarshak.routing.MargdarshakDirection} object with the values provided.
         *
         * @return a new instance of Mapbox Directions
         * @since 2.1.0
         */
        public com.margdarshak.routing.MargdarshakDirection build() {
            if (origin != null) {
